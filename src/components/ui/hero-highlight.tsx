...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-screen items-center justify-center bg-black w-screen",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-purple-500 to-fuchsia-500 px-1 pb-1`,
        className,
      )}
    >
      {children}
